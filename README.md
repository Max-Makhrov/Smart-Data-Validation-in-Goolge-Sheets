...
Notes:
* All \*.gs liles from code source are modules in a project. Master.gs is a compressed verstion of all the files. It's made in order to reduce copy-paste work of installstion.
